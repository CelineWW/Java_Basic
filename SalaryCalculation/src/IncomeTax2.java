...
//      annualSalary = 0;
      startingAnnualSalary = 40000;   // FIXME: Change the starting salary to 40000
      endingAnnualSalary = 60000;     // FIXME: Change the ending salary to 60000
      salaryIncrement = 5000;
      
      for (annualSalary = startingAnnualSalary; 
    		  annualSalary <= endingAnnualSalary;
    		  annualSalary = annualSalary + salaryIncrement) {
